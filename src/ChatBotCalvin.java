...
public class ChatBotCalvin
{
	 ...
	 */
	private String [] randomQuestionsAmerican = {"What word means, to make a crisscross pattern on the outside of grilled or broiled food?.", "What food uses a whole turkey?", "What is it called to make a crisscross pattern on the outside of grilled or broiled food?", "What type of dry heat cooking — cook food by submerging it in hot oil called?", "What is it called to add something to food or drink that changes its taste or gives it a particular taste?", "What is it called to add a liquid to dried food so that you can eat it;tenderize verb to make meat soft by hitting it or putting it in a liquid containing oi?", "What food uses 2 pounds freshly ground chuck?", "Q8", "Q9", "Q10"};
	private String [] randomAnswersAmerican = {"Quadriller", "Roast Turkey", "Quadriller", "Deep-fry", "Flake", "reconstitute", "Cheeseburger", "A8", "A9", "A10"};
	private String [] randomQuestionsMexican = {"What word means, a mashed up preparation of avocado that literally means avocado sauce?", "What is a sauce that includes many different spices and chocolate?", "What does pollo mean?", "What does cerveza mean?", "What is a tortilla rolled and filled with a seasoned mixture?", "What are meat and cornmeal wrapped in corn husks called?", "What word means, raw fish marinated in citrus juice, which essentially cooks the delicate seafood?", "Q8", "Q9", "Q10"};
	private String [] randomAnswersMexican = {"Guacamole", "Mole", "Chicken", "Beer", "Enchilada", "Tamales", "Ceviche", "A8", "A9", "A10"};
