...
public class ChatBotSheba
{
    ...
    String MWordList = "Molé (moh-leh); A sauce that includes many different spices and chocolate. And make sure you know these eight common Spanish phrases.;Guacamole (guah-kah-moh-leh); A mashed up preparation of avocado that literally means avocado sauce.;Enchilada (ehn-chee-lah-dah); A tortilla (pictured on the left) rolled and filled with a seasoned mixture, usually containing meat, and covered with a sauce flavored with chili.Origin: enchilado or spiced with chili.;Tamales (tuh-mah-lehs); Meat and cornmeal (masa) wrapped in corn husks";
