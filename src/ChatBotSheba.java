...
//gjf
        ...
        while(!userInput.equals("3")) {
            ...
            System.out.println("");
            System.out.print(" learn more food terms (press 1) or use our food word search (press 2) or leave 3 :( ");
   ...
   /* catch (InputMismatchException e)
    ...
    public static String getItem(String[] list)
    {
        int randIdx = 0;
        randIdx = (int) Math.round(Math.random() * (list.length - 1));
        return list[randIdx];
    }
    ...
    public String find(String word, String[]listOne,String[] oneDef,String[]listTwo,String[] twoDef,String[]listThree,String[] threeDef,String[]listFour,String[] fourDef,String[] phrase)
    {
        ...
        for(int x = 0; x<listThree.length-1;x++){
