...
public class ChatBotSheba
{
	...
	public void dictionary (int cuisine)
	{
		...
		System.out.println("Cooking is so much fun but it can be difficult to read recipes due to the strange vocabulary. You like " + chosenWord + " food, so do you know what " + chosenFood + " means?");
