...
public class ChatBotSheba
{
	...
	public static void makearray (String[] list, String[] listOne, String[] listTwo)
    {
        ...
        for(int x=0;x<list.length-1;x++)
        {
            ...
            if(x%2 == 0)
            {
                listOne[idxOne] = list[x];
                idxOne++;
            }
            else {
                listTwo[idxTwo] = list[x];
                idxTwo++;
            }
